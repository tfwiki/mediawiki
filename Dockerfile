...
RUN wget https://github.com/tideways/php-xhprof-extension/releases/download/v5.0.2/tideways-xhprof_5.0.2_amd64.deb
RUN dpkg -i tideways-xhprof_5.0.2_amd64.deb
RUN docker-php-ext-enable /usr/lib/tideways_xhprof/tideways_xhprof-7.2.so
